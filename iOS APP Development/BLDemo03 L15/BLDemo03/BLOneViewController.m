...
- (void)viewDidLoad {
    ...
    pushButton.frame = CGRectMake(10, 30, self.view.bounds.size.width - 20, 44);
    ...
    presentButton.frame = CGRectMake(10, 84, self.view.bounds.size.width - 20, 44);
    ...
    // add a label
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(10, imageView.frame.origin.y + imageView.frame.size.height + 20, self.view.frame.size.width - 20, 20)];
